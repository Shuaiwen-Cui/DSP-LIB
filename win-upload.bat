...
@REM git push -f https://github.com/Shuaiwen-Cui/DSP-LIB.git main
git push -f https://github.com/Shuaiwen-Cui/DSP-LIB.git main
@REM git remote add origin https://github.com/Shuaiwen-Cui/DSP-LIB.git
@REM git push -u origin main
echo '--------push to GitHub successfully--------'

@REM git push -f <url> main
@REM git push -u <url> main
